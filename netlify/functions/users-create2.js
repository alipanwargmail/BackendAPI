...
exports.handler = async function (event, context) {
  ...
  if (event.httpMethod == 'OPTIONS') {
    ...
    try {
      ...
      const result = await db.query('INSERT INTO users (username, email, password, phone_no, role_user, created_at, updated_at, anper) VALUES ($1, $2, $3, $4, $5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, $6) RETURNING *', 
        [lusername, lemail, hash, lphone_no, lrole_user, lanper])
      console.log(result)
      json_msg = result;
    }
    catch (e) {
